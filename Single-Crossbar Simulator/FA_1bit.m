function [out_s,out_Cout,inter,cyc_num_tot,MAGICs_num_tot] = FA_1bit(a,b,Cin,out)
...
if (all(out))
    ...
    [inter(:,5),cyc_num(5),MAGICs_num(5)] = NOR2_bitwise(Cin,inter(:,4),out(:,5));
    [inter(:,6),cyc_num(6),MAGICs_num(6)] = NOR2_bitwise(inter(:,5),inter(:,4),out(:,6));
    [inter(:,7),cyc_num(7),MAGICs_num(7)] = NOR2_bitwise(Cin,inter(:,5),out(:,7));
    [out_s,cyc_num(8),MAGICs_num(8)] = NOR2_bitwise(inter(:,6),inter(:,7),out(:,8));
    [out_Cout,cyc_num(9),MAGICs_num(9)] = NOR2_bitwise(inter(:,1),inter(:,5),out(:,9));
