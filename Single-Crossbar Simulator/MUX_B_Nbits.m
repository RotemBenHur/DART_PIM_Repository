function [out_mux,inter,cyc_num_tot,MAGICs_num_tot] = MUX_B_Nbits(A,B,sel,out)
...
if (all(out))
    ...
    for i = 1:N
        [out_mux(:,i),inter(:,(i-1)*mux_1bit_inter_num+1:i*mux_1bit_inter_num),cyc_num(i),MAGICs_num(i)] = MUX_b_1bit(A(:,i),B(:,i),sel,out(:,(i-1)*mux_1bit_out_num+1:i*mux_1bit_out_num));
    end
